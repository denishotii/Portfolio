...
if (isset($_GET['title'])) {
    ...
    $mail ->isHTML(true);
    $mail ->Subject = 'Denis Hoti | New Blog is OUT';

    $mail->Body    = '
        <p>Hi, this is an Email from Denis.</p>
        <p>I have just posted my new Blog:<b>'.$title.'</b></p>
        <p>A short description: <b>'.$description.'<b></p>
        <p>Have a look <a href="http://localhost/Portfolio/blog.php">HERE</a></p>
        <br><br>
...
if(!$mail->send()){
    ...
    header("Location: ../addNew.php?error=Blog addedd SUCCESSFULLY also EMAIL SENT TO ALL SUBSCRIBERS");
